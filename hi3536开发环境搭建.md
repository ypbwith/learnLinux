...
ffplay rtmp://192.168.3.144/live  -fflags nobuffer
...
setenv serverip 192.168.3.143
setenv ipaddr 192.168.3.144
setenv ethaddr B0:7E:CF:2F:30:B4
...
s32Ret = HI_MPI_VO_GetWbcDepth (VoWbc, &u32Depth);
...
s32Ret = HI_MPI_VO_SetWbcDepth (VoWbc, u32Depth);
...
if (HI_SUCCESS != HI_MPI_VO_GetWbcFrame(VoWbc, pstFrame))
{
printf("Get wbc screen frame failed!\n");
return HI_FAILURE;
}
/* do some process, i.e. store file or do JPEG encodeing ... */
if (HI_SUCCESS != HI_MPI_VO_ReleaseWbcFrame(VoWbc, pstFrame))
{
...
{"PackCmd":"1","CtrlCmd":"PLAYRECORDFILE"}
