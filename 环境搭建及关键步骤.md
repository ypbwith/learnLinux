...
![img](https://images.cnblogs.com/OutliningIndicators/ContractedBlock.gif) ch-mount.sh
...
./configure --prefix=/root/lib/libnginx --add-module=/root/lib/libnginx/nginx-rtmp-module --with-http_ssl_module
